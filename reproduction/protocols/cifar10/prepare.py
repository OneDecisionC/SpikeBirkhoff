...
def main():
    ...
    if reference_path.exists():
        ...
        assert generated["indices"] == reference["indices"]
    ...
    for method in PROTOCOL["methods"]:
        ...
        command = [PYTHON, str(ROOT / "holdout.py"), "--config",
                   str(ROOT / "source/configs/cifar10_d6_t4.yaml"),
    ...
    write_new(ROOT / "freeze.json", {
        ...
        "preflight": "Fixed stratified CIFAR10 split checked; four training smokes, validation-only evaluation and premature-test rejection passed. No internal or official test evaluation."
    })
    records = []
